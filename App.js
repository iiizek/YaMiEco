        ...
        <Background>
            ...
            <WrapperAuth>
                <AuthInputs>
                    ...
                    />
                    <Input placeholder="Эл. почта" placeholderTextColor="#8fa896" />
                    <InputDate
                        style={authType[0] === true ? { display: 'none' } : {}}
                        value={choosenDate ? choosenDate.toString() : ''}
                    ...
                    />
                    <Input placeholder="Пароль" placeholderTextColor="#8fa896" />
                    <Input
                        style={authType[0] === true ? { display: 'none' } : {}}
